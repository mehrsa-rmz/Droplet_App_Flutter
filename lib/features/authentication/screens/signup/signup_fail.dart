...
class SignupScreenFail extends StatelessWidget {
  const SignupScreenFail({super.key});
            ...
            child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                        'We ran into some difficulties when creating your account. Try again and if the problem persists, contact technical support.',
