...
class NewAppointmentsScreen extends StatefulWidget {
  const NewAppointmentsScreen({super.key});

  @override
  State<NewAppointmentsScreen> createState() => _NewAppointmentsScreenState();
}
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text('Make appointment for online consultation',
                        ...
                        Container(
                          ...
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text('Make appointment based on location',
                                  style: tButton.copyWith(color: blue7)),
                              const SizedBox(height: 8)
                            ],
                          ),
                        ...
                        Container(
                          ...
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text('Make appointment based on specialist',
                                  style: tButton.copyWith(color: blue7)),
                              const SizedBox(height: 8)
                            ],
                          ),
